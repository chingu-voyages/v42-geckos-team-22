...
function GameHeading(props) {
  const userName = props.currentUser ? props.currentUser.displayName : "";

  return (
    <div className={props.cname}>
      <div className="flex aspect-square flex-col justify-around border-b-4 border-r-4 border-black bg-light-orange md:w-2/5 lg:w-1/5">
      ...
      <div className="header-stripes flex flex-auto justify-around border-b-4 border-black bg-red-orange md:w-4/5 ">
