    ...
    <div className=" h-full md:h-screen">
      <div className="flex h-full w-full flex-col items-center justify-start md:grid md:grid-cols-2 md:grid-rows-[15]">
        ...
        <div className="relative mb-12 flex h-[12rem] w-full flex-col rounded-sm md:row-span-5 md:mb-0 md:h-full md:rounded-none md:ring-2 md:ring-black">
          ...
          <div className="relative ml-8 h-full bg-orange md:ml-0 md:flex md:items-center md:ring-2 md:ring-black">
        ...
        {seeMore ? (
          ...
          <p
            ...
            className="h-full cursor-pointer pb-4 text-sm font-semibold md:col-span-2 md:row-span-1 md:grid md:place-content-center md:pb-0 md:ring-2 md:ring-black"
          >
            SEE MORE \\\\\\
          </p>
        )}
