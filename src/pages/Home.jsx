    ...
    <div>
      ...
      <div className="flex flex-row flex-wrap md:w-screen">
        ...
        <div className="hidden md:flex flex-col md:w-7/12">
          ...
          <div className="h-24 bg-pink border-black border-2 md:border-r-0 bg-center bg-[url('/src/assets/waves.svg')]  bg-repeat">
          </div>
        </div>
      ...
      {/* Games list */}
      <div className="border-black border-4 h-28 w-64 mx-auto">
        <p>NUMBER</p>
      </div>
      <div className="border-black border-4 h-28 w-64 mx-auto">
        <p>SHAPE</p>
