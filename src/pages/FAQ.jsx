  ...
  return (
    <div className="relative p-5 md:p-0">
      ...
      <div className="absolute right-0 -z-20 hidden h-40 w-4/6 bg-light-orange md:block lg:h-60">
        <img
          className="absolute left-44 w-28 lg:w-40 lg:left-96"
          src="src/assets/faqVector.svg"
          alt="faq vector"
        />
        <img
          className="absolute right-0 -bottom-14 w-44 lg:w-60 lg:-bottom-20"
      ...
      <section className="md:pt-16 md:pb-16">
        ...
        <span className="hidden text-7xl font-extrabold md:block md:pl-14 md:pb-6 lg:text-9xl lg:pl-32">
          Frequently
        </span>
        <span className="hidden pl-36 text-5xl font-light md:block lg:text-7xl lg:pl-72 lg:pt-8">
          asked questions
        </span>
      </section>
      {content}
